...
/**
 * Carrusel reutilizable con Embla:
 * - Flechas de navegación visibles solo en hover con fade
 * - Dots indicadores opcionales
 * - Máximo 7 cards en desktop
 * - Responsive breakpoints
 */
export default function Carousel({ items, title, showDots = false }: CarouselProps) {
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 space-y-3">
        {/* Header con título y dots opcionales */}
        {(title || showDots) && (
        ...
        <div className="relative group">
          {/* Flecha izquierda - visible solo en hover con fade */}
          <button
            onClick={scrollPrev}
            ...
            <div className="flex">
              {items.map((media) => (
                <div
                  ...
                  className="flex-[0_0_25%] min-w-0 px-2 sm:flex-[0_0_20%] md:flex-[0_0_16.66%] lg:flex-[0_0_14.28%]"
                >
          ...
          {/* Flecha derecha - visible solo en hover con fade */}
          <button
            onClick={scrollNext}
